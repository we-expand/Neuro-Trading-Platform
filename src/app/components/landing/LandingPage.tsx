...
export const LandingPage = ({ onLoginClick, onRegisterClick, lang, setLang }: { onLoginClick: () => void; onRegisterClick: () => void; lang: Language; setLang: (l: Language) => void }) => {
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            ...
            */}
            <button 
              ...
              className="hidden md:block bg-transparent text-white border border-white/20 px-6 py-2 rounded-full font-medium hover:bg-white/10 transition-colors text-sm tracking-wide"
            >
              {t.nav.login}
            </button>
            <button 
