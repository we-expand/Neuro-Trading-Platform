...
export const useMarketContext = () => {
  ...
  if (!context) {
    // ⚠️ SAFETY: Durante React Hot Reload ou inicialização, o contexto pode não estar disponível ainda
    // Retornamos valores padrão seguros ao invés de lançar erro imediatamente
